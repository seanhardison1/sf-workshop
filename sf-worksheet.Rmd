...
5. Go to maps.google.com, find a couple of points, and calculate the distance between them with `st_distance`.
...
#1. Use st_bbox to define your bounding box. Don't forget to set you CRS!!

#2. Use st_crop to crop the topography object. 

#3. Visualize the output using ggplot2
...
#nmax: number of observations to use for modeling mean length

# Visualize sample spatial autocorrelation
